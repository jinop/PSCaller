    ...
    private static void Main(string[] args)
    {
      ...
      using (runspacePool)
      {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            // between running commands with a runspace and running commands with a runspace pool.
            ...
            // The three lines below look the same running with a runspace or with a runspace pool.
